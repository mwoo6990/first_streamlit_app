...
def get_fruityvice_data(this_fruit_choide):
    fruityvice_response = requests.get(f"https://fruityvice.com/api/fruit/{this_fruit_choide}")
...
try:
  fruit_choice = streamlit.text_input("What fruit would you like information about?", "pineapple")
